    ...
    Canvas(modifier = modifier) {
        ...
        for(i in minWeight..maxWeight) {
            ...
            if (lineType == LineType.TenStep) {
                drawContext.canvas.nativeCanvas.apply {
                    val textRadius = (outerScaleRadius - lineLength - 5.dp.toPx() - style.textSize.toPx())
                    ...
                    withRotation(
                        ...
                        drawText(
                            ...
                            y,
                            Paint().apply {
                                color = argb((lineColor.alpha*255).toInt(), (lineColor.red*255).toInt(), (lineColor.green*255).toInt(), (lineColor.blue*255).toInt())
